...
public class SoulwoodBoatItem extends BoatItem {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final String WOOD_TYPE;
    private final boolean HAS_CHEST;

    public SoulwoodBoatItem(boolean hasChest, Properties properties, WoodType woodType) {
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return HAS_CHEST ? new SWChestBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE) : new SWBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE);
    }
}