...
public class FeatureInit {
    ...
    public static final Supplier<Feature<TreeConfiguration>> SOUL_TREE_MINI = FEATURES.register("soul_tree_mini", () -> new TreeFeature(TreeConfiguration.CODEC));
    public static final Supplier<Feature<GeodeConfiguration>> VIBRANIUM_GEODE = FEATURES.register("vibranium_geode", () -> new VibraniumGeodeFeature(GeodeConfiguration.CODEC));
