...
import de.bigbull.vibranium.init.custom.item.*;
...
public class ItemInit {
    ...
    public static final DeferredItem<Item> VIBRANIUM_UPGRADE_SMITHING_TEMPLATE = ITEMS.register("vibranium_upgrade_smithing_template",
            VibraniumUpgradeTemplate::createVibraniumUpgradeTemplate);

    public static final DeferredItem<DeferredSpawnEggItem> VIBRA_GOLEM_SPAWN_EGG = ITEMS.register("vibra_golem_entity_spawn_egg",
            () -> new DeferredSpawnEggItem(EntitiesInit.VIBRA_GOLEM, 0x28272B, 0x020250,
                    new Item.Properties()
                    .stacksTo(16)));
    ...
    public static final DeferredItem<SwordItem> VIBRANIUM_SWORD = ITEMS.register("vibranium_sword", () ->
            new SwordItem(MaterialsInit.VIBRANIUM, new Item.Properties()
                    .fireResistant()
                    .attributes(SwordItem.createAttributes(MaterialsInit.VIBRANIUM, 3.0f, -2.2f))));

    public static final DeferredItem<PickaxeItem> VIBRANIUM_PICKAXE = ITEMS.register("vibranium_pickaxe", () ->
            new PickaxeItem(MaterialsInit.VIBRANIUM, new Item.Properties()
                    .fireResistant()
                    .attributes(PickaxeItem.createAttributes(MaterialsInit.VIBRANIUM, 0.0f, -2.8f))));

    public static final DeferredItem<AxeItem> VIBRANIUM_AXE = ITEMS.register("vibranium_axe", () ->
            new AxeItem(MaterialsInit.VIBRANIUM, new Item.Properties()
                    .fireResistant()
                    .attributes(AxeItem.createAttributes(MaterialsInit.VIBRANIUM, 5.0f, -3.0f))));

    public static final DeferredItem<ShovelItem> VIBRANIUM_SHOVEL = ITEMS.register("vibranium_shovel", () ->
            new ShovelItem(MaterialsInit.VIBRANIUM, new Item.Properties()
                    .fireResistant()
                    .attributes(ShovelItem.createAttributes(MaterialsInit.VIBRANIUM, 0.5f, -3.0f))));

    public static final DeferredItem<HoeItem> VIBRANIUM_HOE = ITEMS.register("vibranium_hoe", () ->
            new HoeItem(MaterialsInit.VIBRANIUM, new Item.Properties()
                    .fireResistant()
                    .attributes(HoeItem.createAttributes(MaterialsInit.VIBRANIUM, -5.0f, 0.0f))));
    ...
    public static final DeferredItem<VibraniumMaceItem> VIBRANIUM_MACE = ITEMS.register("vibranium_mace", () ->
            new VibraniumMaceItem(MaterialsInit.VIBRANIUM, BlockTags.MINEABLE_WITH_PICKAXE,
                    new Item.Properties()
                            .fireResistant()
                            .rarity(Rarity.EPIC)
                            .attributes(VibraniumMaceItem.createAttributes(MaterialsInit.VIBRANIUM, 0.5f, -3.0f))));
    ...
    public static final DeferredItem<Item> SOUL_HERB_ELIXIR = ITEMS.register("soul_herb_elixir",
            () -> new HSHPotionItem(new Item.Properties()
                    .stacksTo(1),3600, 0));
    ...
    public static final DeferredItem<Item> SOULWOOD_SIGN = ITEMS.register("soulwood_sign",
            () ->  new SignItem(new Item.Properties()
                    .stacksTo(16), BlockInit.SOULWOOD_SIGN.get(), BlockInit.SOULWOOD_WALL_SIGN.get()));
    ...
    public static final DeferredItem<Item> SOULWOOD_BOAT = ITEMS.register("soulwood_boat",
            () ->  new SoulwoodBoatItem(false, new Item.Properties()
                    .stacksTo(1), TypesInit.SOULWOOD_WOODTYPE));

    public static final DeferredItem<Item> SOULWOOD_CHEST_BOAT = ITEMS.register("soulwood_chest_boat",
            () ->  new SoulwoodBoatItem(true, new Item.Properties()
                    .stacksTo(1), TypesInit.SOULWOOD_WOODTYPE));
}