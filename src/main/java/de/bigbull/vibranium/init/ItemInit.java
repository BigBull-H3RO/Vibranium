...
public class ItemInit {
        public static final DeferredRegister.Items ITEMS = DeferredRegister
                        .createItems(de.bigbull.vibranium.Vibranium.MODID);
        ...
        // public static final DeferredItem<SpawnEggItem> VIBRA_GOLEM_SPAWN_EGG =
        // ITEMS.registerItem("vibra_golem_spawn_egg",
        // properties -> new SpawnEggItem(EntitiesInit.VIBRAGOLEM.get(), properties));

        public static final DeferredItem<Item> VIBRANIUM_UPGRADE_SMITHING_TEMPLATE = ITEMS.registerItem(
                        "vibranium_upgrade_smithing_template",
                        ...
                        properties -> new ShieldItem(properties
                                        ...
                                        .component(
                                                        ...
                                                        new BlocksAttacks(
                                                                        ...
                                                                        new BlocksAttacks.ItemDamageFunction(3.0F, 1.0F,
                                                                                        1.0F),
                                                                        Optional.empty(),
        ...
        // Advanced Items
        public static final DeferredItem<BlockItem> HEART_SHAPED_HERB = ITEMS.registerSimpleBlockItem(
                        "heart_shaped_herb",
                        BlockInit.HEART_SHAPED_HERB_BUSH, properties -> new Item.Properties()
                                        .food(FoodPropertiesInit.HEART_SHAPED_HERB,
                                                        FoodPropertiesInit.HEART_SHAPED_HERB_EFFECT)
                                        .rarity(Rarity.RARE)
                                        .stacksTo(16));
        ...
        public static final DeferredItem<Item> SOUL_HERB_ELIXIR_EXTENDED = ITEMS.registerItem(
                        "soul_herb_elixir_extended",
                        properties -> new HSHPotionItems(properties
                                        .rarity(Rarity.RARE)
                                        .stacksTo(1), 9600, 0));

        public static final DeferredItem<Item> SOUL_HERB_ELIXIR_ENHANCED = ITEMS.registerItem(
                        "soul_herb_elixir_enhanced",
                        properties -> new HSHPotionItems(properties
                                        .rarity(Rarity.RARE)
                                        .stacksTo(1), 1800, 1));
        ...
        public static final DeferredItem<Item> SOULWOOD_HANGING_SIGN = ITEMS.registerItem("soulwood_hanging_sign",
                        properties -> new HangingSignItem(BlockInit.SOULWOOD_HANGING_SIGN.get(),
                                        BlockInit.SOULWOOD_WALL_HANGING_SIGN.get(), properties
                                                        .stacksTo(16)));
