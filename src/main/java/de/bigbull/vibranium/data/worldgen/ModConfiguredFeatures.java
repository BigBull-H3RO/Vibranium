...
public class ModConfiguredFeatures {
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_VIBRANIUM_ORE = registerKey("overworld_vibranium_ore");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SOUL_TREE = registerKey("soul_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SOUL_TREE_SMALL = registerKey("soul_tree_small");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SOUL_TREE_MINI = registerKey("soul_tree_mini");
    public static final ResourceKey<ConfiguredFeature<?, ?>> VIBRANIUM_GEODE = registerKey("vibranium_geode");
