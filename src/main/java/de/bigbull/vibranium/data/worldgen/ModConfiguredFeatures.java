...
public class ModConfiguredFeatures {
        protected static ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_VIBRANIUM_ORE = createKey(
                        "overworld_vibranium_ore");
        ...
        public static TreeConfiguration.TreeConfigurationBuilder soulTree() {
                return new TreeConfiguration.TreeConfigurationBuilder(
                                ...
                                BlockStateProvider.simple(net.minecraft.world.level.block.Blocks.DIRT)).ignoreVines();
        }
        ...
        public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
                ...
                List<OreConfiguration.TargetBlockState> VibraniumOre = List.of(
                                OreConfiguration.target(stoneReplacable,
                                                BlockInit.DEEPSLATE_VIBRANIUM_ORE.get().defaultBlockState()),
                                OreConfiguration.target(deepslateReplacable,
                                                BlockInit.DEEPSLATE_VIBRANIUM_ORE.get().defaultBlockState()));

                FeatureUtils.register(context, OVERWORLD_VIBRANIUM_ORE, Feature.ORE,
                                new OreConfiguration(VibraniumOre, 4));
                FeatureUtils.register(context, VIBRANIUM_GEODE, FeatureInit.VIBRANIUM_GEODE.get(),
                                new GeodeConfiguration(
                                                new GeodeBlockSettings(
                                                                BlockStateProvider.simple(Blocks.AIR),
                                                                BlockStateProvider.simple(
                                                                                BlockInit.VIBRANIUM_CRYSTAL_BLOCK
                                                                                                .get()),
                                                                BlockStateProvider.simple(
                                                                                BlockInit.BUDDING_VIBRANIUM_CRYSTAL
                                                                                                .get()),
                                                                BlockStateProvider.simple(Blocks.CALCITE),
                                                                BlockStateProvider.simple(Blocks.SMOOTH_BASALT),
                                                                List.of(
                                                                                BlockInit.SMALL_VIBRANIUM_BUD.get()
                                                                                                .defaultBlockState(),
                                                                                BlockInit.MEDIUM_VIBRANIUM_BUD.get()
                                                                                                .defaultBlockState(),
                                                                                BlockInit.LARGE_VIBRANIUM_BUD.get()
                                                                                                .defaultBlockState(),
                                                                                BlockInit.VIBRANIUM_CLUSTER.get()
                                                                                                .defaultBlockState()),
                                                                context.lookup(net.minecraft.core.registries.Registries.BLOCK).getOrThrow(BlockTags.FEATURES_CANNOT_REPLACE),
				context.lookup(net.minecraft.core.registries.Registries.BLOCK).getOrThrow(BlockTags.GEODE_INVALID_BLOCKS)),
                ...
                FeatureUtils.register(context, SOUL_TREE_SMALL, FeatureInit.SOUL_TREE_SMALL.get(),
                                soulTreeSmall().build());
                FeatureUtils.register(context, SOUL_TREE_MINI, FeatureInit.SOUL_TREE_MINI.get(),
                                soulTreeMini().build());
        }
