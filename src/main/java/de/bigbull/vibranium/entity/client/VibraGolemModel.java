...
public class VibraGolemModel extends EntityModel<VibraGolemRenderState> {
	...
	public void setupAnim(VibraGolemRenderState state, float netHeadYaw, float headPitch, float limbSwing, float limbSwingAmount, float ageInTicks, VibraGolemEntity entity) {
		...
		this.animate(entity.idleAnimationState, ModAnimationDefinitions.VibraGolemAnimation.idle, ageInTicks, 1f);
		this.animate(entity.attackAnimationState, ModAnimationDefinitions.VibraGolemAnimation.attack, ageInTicks, 1f);
	}
